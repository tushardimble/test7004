<?php
	...
	$fdamount = str_replace(' ', '', $fdamount);
	$lockingperiods = str_replace(' ', '', $lockingperiods);
	$curl2 = curl_init();
	curl_setopt_array($curl2, array(
	  CURLOPT_URL =>  $basepath."crmapi/updatefdamount.php?account_number=$account_number&lockingperiods=$lockingperiods&fdamount=$fdamount",
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => "",
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 0,
